...
MPU9250::cal_mag MPU9250::get_cal_mag() {
	write(adress_mag, 0xA, 0x00);
	hwlib::wait_ms(10);
	write(adress_mag, 0xA, 0x0F);
	hwlib::wait_ms(10);
...
int16_t MPU9250::get_x_mag() {
	return read_2_bytes(adress_mag, REG_MAG_XOUT_L, REG_MAG_XOUT_H);
	}
int16_t MPU9250::get_y_mag() {
	return read_2_bytes(adress_mag, REG_MAG_YOUT_L, REG_MAG_YOUT_H);
	}
int16_t MPU9250::get_z_mag() {
	return read_2_bytes(adress_mag, REG_MAG_ZOUT_L, REG_MAG_ZOUT_H);
	}
